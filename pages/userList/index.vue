<template>
	<view>
		<u-modal v-model="TipsIF" :content="content" @confirm="removeUser" :show-cancel-button="true"
			:async-close="true">
		</u-modal>
		<view class="searchBox">
			<u-search placeholder="请输入用户名称" @change="searchChange" v-model="keyword" action-text="添加" :clearabled="true"
